...
class BATOMS_MT_molecular_surface_context_menu(Menu):
    ...
    def draw(self, _context):
        layout = self.layout
        op = layout.operator(
            "surface.molecular_surface_add", icon="ADD", text="Add Molecular Surface"
        )
        layout.separator()
        op = layout.operator(
            "surface.molecular_surface_remove",
            icon="X",
...
class BATOMS_PT_molecular_surface(Panel):
    ...
    def draw(self, context):
        ...
        col.menu(
            "BATOMS_MT_molecular_surface_context_menu", icon="DOWNARROW_HLT", text=""
        )
